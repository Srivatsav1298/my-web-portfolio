...
const timelineData = [
  {
    ...
    description: 'Leading data infrastructure initiatives, building scalable ETL pipelines, and implementing ML ops practices.',
  ...
  },
  {
    ...
    title: 'Data Engineer',
    company: 'Startup Inc',
    description: 'Designed and implemented real-time data streaming solutions and analytics dashboards.',
    technologies: ['Kafka', 'PostgreSQL', 'Docker', 'React'],
    type: 'work',
  },
  {
    id: 3,
    ...
    description: 'Built an LLM-powered application for automated document analysis and insights extraction.',
    technologies: ['LangChain', 'OpenAI', 'FastAPI', 'Vector DB'],
    type: 'project',
  },
  {
    id: 4,
    ...
    description: 'Full-stack development focusing on data-driven applications and API integrations.',
    technologies: ['JavaScript', 'Node.js', 'MongoDB', 'REST APIs'],
    type: 'work',
  },
];
